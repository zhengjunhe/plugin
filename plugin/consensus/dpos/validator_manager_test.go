...
func TestMakeGenesisValidatorMgr(t *testing.T) {
	...
	require.Nil(t, err)
	assert.True(t, vMgr.ChainID == "dplatformos-Z2cgFj")
	...
	vMgrCopy := vMgr.Copy()
	assert.True(t, vMgrCopy.ChainID == "dplatformos-Z2cgFj")
