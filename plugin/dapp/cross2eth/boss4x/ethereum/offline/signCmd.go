...
func (s *SignCmd)SignContractTx(cmd *cobra.Command, args []string){
	...
	var signData=make([]*eoff.DeploayContract,0)
...
func (s *SignCmd)signValSet(validators []common.Address,powers []*big.Int)(*eoff.DeploayContract){
	...
	var valSet eoff.DeploayContract
...
func (s *SignCmd)signChain33Bridge(nonce uint64,operater ,valSetAddr common.Address )(*eoff.DeploayContract){
	...
	var bridge eoff.DeploayContract
	bridge.Nonce=nonce
...
func (s*SignCmd)signOracle(nonce uint64,valsetAddr,bridgeAddr common.Address)(*eoff.DeploayContract){
	...
	var oracle eoff.DeploayContract
	oracle.Nonce=nonce
...
func (s*SignCmd)SignBridgeBank(nonce uint64,bridgeAddr,oracalAddr common.Address)(*eoff.DeploayContract){
...
func (s *SignCmd)SignSetBridgeBank(nonce uint64,bridgebank ,chain33bridge common.Address)(*eoff.DeploayContract){
	...
	contractAddress:=crypto.CreateAddress(s.deployerAddr,nonce)
	var setbank eoff.DeploayContract
...
func (s *SignCmd)SignsetOracle(nonce uint64,oracalAddr,chain33bridge common.Address)(*eoff.DeploayContract){
	method:="setOracle"
	parsed, err := abi.JSON(strings.NewReader(generated.Chain33BridgeABI))
	if err != nil {
		panic(err)
	...
	contractAddress:=crypto.CreateAddress(s.deployerAddr,nonce)
	var setoracle eoff.DeploayContract
...
func (s*SignCmd)SignBridgeRegistry(nonce uint64,chain33Bridge,bridgebank,oracleAddr,valSetAddr common.Address)(*eoff.DeploayContract){
	...
	contractAddress:=crypto.CreateAddress(s.deployerAddr,nonce)
	var bridgeRegistry eoff.DeploayContract
