...
func validTitle(cfg *types.DplatformConfig, title string) bool {
	if cfg.IsPara() {
...
func checkCommitInfo(cfg *types.DplatformConfig, commit *pt.ParacrossNodeStatus) error {
	if commit == nil {
...
func makeDoneReceipt(cfg *types.DplatformConfig, execMainHeight, execHeight int64, commit *pt.ParacrossNodeStatus,
...
func paraCheckSelfConsOn(cfg *types.DplatformConfig, db dbm.KV, commit *pt.ParacrossNodeStatus) (bool, *types.Receipt, error) {
...
func isHaveCrossTxs(cfg *types.DplatformConfig, status *pt.ParacrossNodeStatus) bool {
...
func (a *action) assetTransferMainCheck(cfg *types.DplatformConfig, transfer *types.AssetsTransfer) error {
...
func (a *action) assetWithdrawMainCheck(cfg *types.DplatformConfig, withdraw *types.AssetsWithdraw) error {
