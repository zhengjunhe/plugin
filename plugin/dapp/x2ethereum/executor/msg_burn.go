...
type Msg_Burn struct {
	...
	TokenContract    EthAddress     `json:"token_contract_address" yaml:"token_contract_address"`
	Chain33Sender    Chain33Address `json:"chain33_sender" yaml:"chain33_sender"`
	EthereumReceiver EthAddress     `json:"ethereum_receiver" yaml:"ethereum_receiver"`
...
func NewMsgBurn(ethereumChainID int64, tokenContract string, chain33Sender string, ethereumReceiver string, amount uint64) Msg_Burn {
	return Msg_Burn{
		...
		TokenContract:    NewEthAddressByProto(tokenContract),
		Chain33Sender:    NewChain33AddressByProto(chain33Sender),
		EthereumReceiver: NewEthAddressByProto(ethereumReceiver),
		Amount:           amount,
	}
}

// Route should return the name of the module
func (msg Msg_Burn) Route() string { return ModuleName }
