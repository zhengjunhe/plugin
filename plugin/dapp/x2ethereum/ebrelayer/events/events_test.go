...
func Test_NewDplatformMsg(t *testing.T) {
	_ = NewDplatformMsg(MsgBurn, []byte("12qyocayNF7Lv6C9qW4avxs2E7U41fKSfv"), common.HexToAddress("0x0C05bA5c230fDaA503b53702aF1962e08D0C60BF"),
		"eth", big.NewInt(100000000000000000), common.HexToAddress("0x0000000000000000000000000000000000000000"))
}

func Test_DplatformMsgAttributeKey(t *testing.T) {
	assert.Equal(t, UnsupportedAttributeKey.String(), "unsupported")
	assert.Equal(t, DplatformSender.String(), "dplatform_sender")
