...
func testBetRawTxCmd(t *testing.T, cfg *types.DplatformOSConfig, jrpc *jsonclient.JSONClient) error {
...
func testStopBetRawTxCmd(t *testing.T, cfg *types.DplatformOSConfig, jrpc *jsonclient.JSONClient) error {
...
func testPublishRawTxCmd(t *testing.T, cfg *types.DplatformOSConfig, jrpc *jsonclient.JSONClient) error {
...
func testAbortRawTxCmd(t *testing.T, cfg *types.DplatformOSConfig, jrpc *jsonclient.JSONClient) error {
